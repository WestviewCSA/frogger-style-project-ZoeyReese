...
public class HelicopterScrolling{
	...
	public HelicopterScrolling() {
		
		//load the main image (front or forward view)
		forward 	= getImage("/imgs/"+"helicopter.png"); //load the image for Pony
	...
	public HelicopterScrolling(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = HelicopterScrolling.class.getResource(path);
